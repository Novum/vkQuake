...
DECLARE_SHADER_SPV (fte_particles_frag);
DECLARE_SHADER_SPV (fte_particles_msaa_frag);
DECLARE_SHADER_SPV (basic_oit_frag);
DECLARE_SHADER_SPV (basic_mboit_moment_frag);
DECLARE_SHADER_SPV (basic_mboit_composite_frag);
DECLARE_SHADER_SPV (basic_mboit_composite_msaa_frag);
DECLARE_SHADER_SPV (basic_alphatest_frag);
DECLARE_SHADER_SPV (basic_notex_frag);
DECLARE_SHADER_SPV (draw_pic_frag);
DECLARE_SHADER_SPV (draw_pic_alphatest_frag);
DECLARE_SHADER_SPV (draw_pic_xbr_frag);
DECLARE_SHADER_SPV (draw_pic_xbr_alphatest_frag);
DECLARE_SHADER_SPV (draw_pic_xbr_vert);
...
DECLARE_SHADER_SPV (world_mboit_composite_msaa_frag);
...
DECLARE_SHADER_SPV (alias_mboit_moment_frag);
DECLARE_SHADER_SPV (alias_mboit_composite_frag);
DECLARE_SHADER_SPV (alias_mboit_composite_msaa_frag);
DECLARE_SHADER_SPV (alias_alphatest_mboit_moment_frag);
DECLARE_SHADER_SPV (alias_alphatest_mboit_composite_frag);
DECLARE_SHADER_SPV (alias_alphatest_mboit_composite_msaa_frag);
DECLARE_SHADER_SPV (md5_mboit_composite_frag);
DECLARE_SHADER_SPV (md5_alphatest_mboit_composite_frag);
...
DECLARE_SHADER_SPV (ssao_prepare_comp);
DECLARE_SHADER_SPV (ssao_prepare_msaa_comp);
DECLARE_SHADER_SPV (ssao_evaluate_comp);
DECLARE_SHADER_SPV (ssao_evaluate_fp16_comp);
DECLARE_SHADER_SPV (ssao_mip_comp);
DECLARE_SHADER_SPV (ssao_mip_fp16_comp);
DECLARE_SHADER_SPV (ssao_mip_msaa_comp);
DECLARE_SHADER_SPV (ssao_mip_msaa_fp16_comp);
DECLARE_SHADER_SPV (ssao_filter_comp);
DECLARE_SHADER_SPV (ssao_filter_fp16_comp);
...
DECLARE_SHADER_SPV (mboit_resolve_frag);
DECLARE_SHADER_SPV (mboit_resolve_msaa_frag);
