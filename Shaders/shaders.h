...
DECLARE_SHADER_SPV (world_mbot_frag);
...
DECLARE_SHADER_SPV (alias_mbot_frag);
DECLARE_SHADER_SPV (alias_alphatest_mbot_frag);
...
DECLARE_SHADER_SPV (mbot_resolve_frag);
DECLARE_SHADER_SPV (mbot_resolve_msaa_frag);
DECLARE_SHADER_SPV (depth_peel_frag);
DECLARE_SHADER_SPV (hybrid_resolve_frag);
DECLARE_SHADER_SPV (hybrid_resolve_msaa_frag);
