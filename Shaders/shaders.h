...
DECLARE_SHADER_SPV (basic_wavelet_bounds_frag);
DECLARE_SHADER_SPV (basic_wavelet_coeff_frag);
DECLARE_SHADER_SPV (basic_wavelet_shade_frag);
DECLARE_SHADER_SPV (wavelet_resolve_frag);
DECLARE_SHADER_SPV (wavelet_composite_frag);
...
DECLARE_SHADER_SPV (world_wavelet_bounds_frag);
DECLARE_SHADER_SPV (world_wavelet_coeff_frag);
DECLARE_SHADER_SPV (world_wavelet_shade_frag);
...
DECLARE_SHADER_SPV (alias_wavelet_bounds_frag);
DECLARE_SHADER_SPV (alias_wavelet_coeff_frag);
DECLARE_SHADER_SPV (alias_wavelet_shade_frag);
DECLARE_SHADER_SPV (alias_alphatest_wavelet_bounds_frag);
DECLARE_SHADER_SPV (alias_alphatest_wavelet_coeff_frag);
DECLARE_SHADER_SPV (alias_alphatest_wavelet_shade_frag);
