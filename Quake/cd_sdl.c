...
static void CD_f (void)
{
	...
	if (q_strcasecmp (command, "info") == 0)
	{
		...
		if (playing || wasPlaying)
		{
			...
			Con_Printf (
				"Current position: %d:%02d.%02d (of %d:%02d.%02d)\n", current_min, current_sec, current_frame * 60 / CD_FPS, length_min, length_sec,
				length_frame * 60 / CD_FPS);
		}
